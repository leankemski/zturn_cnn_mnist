...
/*  	printf("image virtual addr = %p , physical addr = %#x\n", image, phy1);
	...
	//a file to record
	FILE *pFile = fopen("data/inter_data.dat","w+");
	if(pFile == NULL)
		printf("no file\n");
